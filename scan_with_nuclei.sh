...
cat vuln_links.txt | nuclei -t late~/cent-nuclei-temps -es info,unknown -etags ssl,network -o nuclei_1.txt
cat alive_links.txt | nuclei -t ~/cent-nuclei-templates -es info,unknown -etags ssl,network -o nuclei_2.txt
cat urls.txt | nuclei -t ~/cent-nuclei-templates -es info,unknown -etags ssl,network -o nuclei_3.txt
